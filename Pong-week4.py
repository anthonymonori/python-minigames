# Hi! I'm Anthony. I didn't had much time to finish this
# game, so you'll surely find some bugs.
# E.g. the paddle goes out of the canvas if it's pressed
# twice at the edge, I don't have time to fix it now, but 
# I'll look into it. Hope you like my implementation of
